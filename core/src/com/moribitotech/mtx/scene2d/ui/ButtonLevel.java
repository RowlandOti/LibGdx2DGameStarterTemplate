...
public class ButtonLevel extends AbstractButton {
    ...
    private float starPosXStart = 0f;
    private float starPosYStart = 0f;
    private float starScaleFactor = 1f;
    ...
    public ButtonLevel(BitmapFont bitMapFont, Drawable up, Drawable down) {
     ...
     * button sizes. However further adjustment can be done (optinal) with "setLevelStarScaleFactor", "setLevelStarPosXStart" and "setLevelStarPosYStart".
    ...
    public void setLevelStars(TextureRegion starHolderTexture, TextureRegion starTexture, int numberOfTotalStars, int numberOfEarnedStars) {
        ...
        float btnSizeW = getWidth();
        float btnSizeH = getHeight();
    ...
    /**
     * Get level stars scale factor
     */
    public float getLevelScaleFactor() {
        return starScaleFactor;
    }
     ...
     */
    public void setLevelStarScaleFactor(float starScaleFactor) {
        this.starScaleFactor = starScaleFactor;
        float btnSizeW = getWidth() * this.starScaleFactor;
        float btnSizeH = getHeight() * this.starScaleFactor;
        starSizeWidth = btnSizeW / numberOfTotalStars;
        starSizeHeight = btnSizeH / numberOfTotalStars;
    }
