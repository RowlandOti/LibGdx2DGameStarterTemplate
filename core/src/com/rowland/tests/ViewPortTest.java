...
public class ViewPortTest extends GdxSample {
	...
	public void create() {
		...
		background = new Texture(Gdx.files.internal("data/loading_screen/logo.png"));
	...
	public void render() {
		...
		batch.begin();
		batch.draw(background, -background.getWidth() * 0.5f,
	...
	private void createViewports() {
		...
		viewports.put("StretchViewport", new StretchViewport(MIN_SCENE_WIDTH,
				MIN_SCENE_HEIGHT, camera));
		viewports.put("FitViewport", new FitViewport(MIN_SCENE_WIDTH,
				MIN_SCENE_HEIGHT, camera));
		viewports.put("FillViewport", new FillViewport(MIN_SCENE_WIDTH,
				MIN_SCENE_HEIGHT, camera));
		viewports.put("ScreenViewport", new ScreenViewport(camera));
		viewports.put("ExtendViewport (no max)", new ExtendViewport(
				MIN_SCENE_WIDTH, MIN_SCENE_HEIGHT, camera));
		viewports.put("ExtendViewport (max)", new ExtendViewport(
				MIN_SCENE_WIDTH, MIN_SCENE_HEIGHT, MAX_SCENE_HEIGHT,
